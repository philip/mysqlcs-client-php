...
class AccessRulesApi
{
     ...
     * @return \Swagger\Client\Model\AccessRulesViewResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAccessRules($x_id_tenant_name, $identity_domain_id, $service_id)
    {
        list($response) = $this->getAccessRulesWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id);
        return $response;
    }
     ...
     * @param string $identity_domain_id Name of the identity domain for the MySQL Cloud Service account. (required)
     * @param string $service_id Name of the Oracle MySQL Cloud Service instance. (required)
     * @return Array of \Swagger\Client\Model\AccessRulesViewResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAccessRulesWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id)
    {
        // verify the required parameter 'x_id_tenant_name' is set
        if ($x_id_tenant_name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $x_id_tenant_name when calling getAccessRules');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\AccessRulesViewResponse',
                '/paas/api/v1.1/instancemgmt/{identityDomainId}/services/MySQLCS/instances/{serviceId}/accessrules'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AccessRulesViewResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\AccessRulesViewResponse', $e->getResponseHeaders());
     ...
     * @param string $identity_domain_id Name of the identity domain for the MySQL Cloud Service account. (required)
     * @param string $service_id Name of the Oracle MySQL Cloud Service instance. (required)
     * @param \Swagger\Client\Model\AccessRulesAddPostRequest $payload The request body defines the details of the access rule to add. (required)
     * @return void
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function insertAccessRule($x_id_tenant_name, $identity_domain_id, $service_id, $payload)
    {
        list($response) = $this->insertAccessRuleWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id, $payload);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function insertAccessRuleWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id, $payload)
    {
        // verify the required parameter 'x_id_tenant_name' is set
        if ($x_id_tenant_name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $x_id_tenant_name when calling insertAccessRule');
        }
        // verify the required parameter 'identity_domain_id' is set
        if ($identity_domain_id === null) {
     ...
     * @param \Swagger\Client\Model\AccessRulesUpdatePutRequest $payload The request body defines the details of the disable, enable, or delete request. (required)
     * @return \Swagger\Client\Model\AccessRulesDetails
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateAccessRule($x_id_tenant_name, $identity_domain_id, $service_id, $rule_name, $payload)
    {
        list($response) = $this->updateAccessRuleWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id, $rule_name, $payload);
        return $response;
    }
     ...
     * @param string $rule_name Name of the access rule to disable or enable. (required)
     * @param \Swagger\Client\Model\AccessRulesUpdatePutRequest $payload The request body defines the details of the disable, enable, or delete request. (required)
     * @return Array of \Swagger\Client\Model\AccessRulesDetails, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateAccessRuleWithHttpInfo($x_id_tenant_name, $identity_domain_id, $service_id, $rule_name, $payload)
    {
        // verify the required parameter 'x_id_tenant_name' is set
        if ($x_id_tenant_name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $x_id_tenant_name when calling updateAccessRule');
        }
        // verify the required parameter 'identity_domain_id' is set
        if ($identity_domain_id === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\AccessRulesDetails',
                '/paas/api/v1.1/instancemgmt/{identityDomainId}/services/MySQLCS/instances/{serviceId}/accessrules/{ruleName}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AccessRulesDetails', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\AccessRulesDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 202:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\AccessRulesDetails', $e->getResponseHeaders());
