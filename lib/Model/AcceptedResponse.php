 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AcceptedResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'accepted-response';
    ...
    /**
     * Sets message
     * @param string $message System message that describes the operation. For example: <code>Submitted job to create service [{serviceId}] in domain [{identityDomainId}].</code>
     * @return $this
     */
    ...
    /**
     * Sets job_id
     * @param string $job_id Job ID for the operation.
     * @return $this
     */
    ...
    /**
     * Sets operation_name
     * @param string $operation_name Name of the operation. For example: <code>start-backup</code> or <code>delete-backup</code>
     * @return $this
     */
    ...
    /**
     * Sets target_uri
     * @param string $target_uri Target URI. Poll the URI to get the target information or status of the operation.
     * @return $this
     */
