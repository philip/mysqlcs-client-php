...
/**
 * SshKeyDescriptionItem Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SshKeyDescriptionItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ssh-key-description-item';
    ...
    /**
     * Sets canonical_url
     * @param string $canonical_url URL to query the credential key value.
     * @return $this
     */
