...
/**
 * BackupAcceptedResponse Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BackupAcceptedResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'backup-accepted-response';
    ...
    /**
     * Sets operation_name
     * @param string $operation_name Name of the operation. For example: <code>start-backup</code>, <code>restore-backup</code>, or <code>delete-backup</code>.
     * @return $this
     */
