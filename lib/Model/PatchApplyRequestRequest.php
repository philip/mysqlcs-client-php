...
/**
 * PatchApplyRequestRequest Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PatchApplyRequestRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'patch-apply-request-request';
     ...
     * @param string $additional_note Free-form text to provide additional information about the patch request.
     * @return $this
     */
