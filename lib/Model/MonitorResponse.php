...
class MonitorResponse implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'status' => 'string',
        'domain_name' => 'string',
        'components' => '\Swagger\Client\Model\MonitorComponentsResponse[]',
        'service_type' => 'string',
    ...
    /**
     * Gets components
     * @return \Swagger\Client\Model\MonitorComponentsResponse[]
     */
    ...
    /**
     * Sets components
     * @param \Swagger\Client\Model\MonitorComponentsResponse[] $components Groups the health details for Oracle MySQL Cloud Service components.
     * @return $this
     */
