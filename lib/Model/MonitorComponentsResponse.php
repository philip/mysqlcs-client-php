...
/**
 * MonitorComponentsResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MonitorComponentsResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'monitor-components-response';
    ...
    protected static $swaggerTypes = array(
        'message' => 'string',
        'service_id' => 'int',
        'vm_instances' => '\Swagger\Client\Model\MonitorVm[]',
        'component_id' => 'int',
    ...
    /**
     * Gets vm_instances
     * @return \Swagger\Client\Model\MonitorVm[]
     */
    ...
    /**
     * Sets vm_instances
     * @param \Swagger\Client\Model\MonitorVm[] $vm_instances The health details of each Virtual Machine (VM) associated with the Oracle MySQL Cloud Service component.
     * @return $this
     */
