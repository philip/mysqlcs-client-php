...
/**
 * BackupJobHistory Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BackupJobHistory implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'backup-job-history';
    ...
    /**
     * Sets operation
     * @param string $operation Type of operation that was executed. For example, <code>backup</code>, <code>delete</code>, <code>upload</code>, <code>download</code>, and so on.
     * @return $this
     */
    ...
    /**
     * Sets start_date
     * @param string $start_date Date and time the operation started.
     * @return $this
     */
    ...
    /**
     * Sets complete_date
     * @param string $complete_date Date and time that the operation completed.
     * @return $this
     */
